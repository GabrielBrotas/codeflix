...
from core._shared.validators import ValidatorRules
...
class Category(Entity):
    ...
    def validate(self):
        ...
        name_validator = ValidatorRules(
            self.name, "name").required().string().max_length(255)
        desc_validator = ValidatorRules(
            self.description, "description").string().max_length(255)
        is_active_validator = ValidatorRules(
